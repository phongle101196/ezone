...
import { getAllTablet } from "../../redux/request/apiProductRequest";
import {
  Box,
  Button,
  Card,
...
function Tablet(props) {
  ...
  const getData = async (p) => {
    await getAllTablet({ page: p, size: 10, search: "" }, dispatch, navigate);
  };
  ...
  return (
    ...
    >
      ...
      <Box m={5} alignItems={"center"}>
        <Box display={"flex"} justifyContent={"center"} color={"#76b5c5"}>
